...
<select id="tipo_ruta" name="tipo_ruta" onchange="redireccionar()">
...
<script>
    function redireccionar() {
        var opcion = document.getElementById("tipo_ruta").value;
        switch (opcion) {
            case "Terrestre":
                window.location.href = "ter.php";
                break;
            case "Marina":
                window.location.href = "mar.php";
                break;
            case "Mercantil":
                window.location.href = "mer.php";
                break;
            default:
                break;
        }
